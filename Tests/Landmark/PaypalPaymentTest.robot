...
TC_001_Verify That The Register User Is Able To Place Paypal Home Delivery Order With Valid Paypal Credentials

    [documentation]  This script will place the reg user home delivery paypal order : Areas Covered [Sign-in,Search,PLP,PDP,Add To Basket,Checkout Now,Choose HD,Choose PAYPAL Payment, Place The Order]
    [tags]  Regression

     Capture Page Screenshot	home_page.png
     Navigate To Sing-In Page
     Verify Sign-In Message
     Verify Login In Page Details
...
#TC_002_Verify That The Register User Is Able To Place Paypal Click And Collect Order With Valid Paypal Credentials
#
...
#
#
#TC_003_Verify That The Guest User Is Able To Place Paypal CNC Order With Valid Paypal Credentials
#
